...
|---|---|---|---|
| [`docs/REPOSITORY_CONVENTIONS.md`](docs/REPOSITORY_CONVENTIONS.md) | 1.0.0 | Initialize | Repository structure, naming conventions, folder ownership, branch/commit rules |
| [`docs/STATUS_MODEL.md`](docs/STATUS_MODEL.md) | 1.0.0 | Initialize | Run and Job lifecycle states, transitions, timestamp conventions |
| [`docs/VERSIONING_POLICY.md`](docs/VERSIONING_POLICY.md) | 1.0.0 | Initialize | Public schema versioning rules, adapter strategy, compatibility and deprecation policy |
| [`docs/ARTIFACT_CONVENTION.md`](docs/ARTIFACT_CONVENTION.md) | 1.0.0 | Initialize | Artifact directory layout, file definitions, append-only policy, scenario comparison policy, manifest format with engine versions. |

### Architecture Decision Records [(`docs/adr/`)](docs/adr/)

| File | Version | Status | Decision |
|---|---|---|---|
| [`docs/adr/ADR-0001-run-based-append-only-model.md`](docs/adr/ADR-0001-run-based-append-only-model.md) | 1.0.0 | Initialize | Run-based execution; all artifacts immutable and append-only |
| [`docs/adr/ADR-0002-equipment-centric-execution-model.md`](docs/adr/ADR-0002-equipment-centric-execution-model.md) | 1.0.0 | Initialize | Stage = SOP identity; WorkUnit = execution via `covered_stage_ids[]` only; integration structural; stage weights by adapter; reliability fields in WorkUnit |
| [`docs/adr/ADR-0003-adapter-based-versioning.md`](docs/adr/ADR-0003-adapter-based-versioning.md) | 1.0.0 | Initialize | All version handling and stage weight computation in Platform Adapter; engines consume canonical only |

### Data Governance [(`data/documentation/`)](data/documentation/)

| File | Version | Status | Purpose |
|---|---|---|---|
| [`data/documentation/DATA_DICTIONARY.md`](data/documentation/DATA_DICTIONARY.md) | 1.0.0 | Initialize | All domain entities, flow model concept, footprint model, KPI, failure modes FM-01–FM-10, reliability fields, status enumerations |
| [`data/documentation/VERSION_REGISTRY.md`](data/documentation/VERSION_REGISTRY.md) | 1.0.0 | Initialize | Registry of all public schema versions and lifecycle status |
| [`data/documentation/CANONICAL_MODEL.md`](data/documentation/CANONICAL_MODEL.md) | 1.0.0 | Initialize | 15 design principles governing the canonical scenario model. |

### Lineage Policy [(`data/lineage/`)](data/lineage/)

| File | Version | Status | Purpose |
|---|---|---|---|
| [`data/lineage/LINEAGE_POLICY.md`](data/lineage/LINEAGE_POLICY.md) | 1.0.0 | Initialize | Artifact lineage, dependency threads, run regeneration requirements, artifact-only A/B comparison policy. |
...
5. **Stage weights computed by Adapter, pre-materialized in canonical** — engines never compute attribution.
